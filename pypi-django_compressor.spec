...
Version  : 4.3
Release  : 72
URL      : https://files.pythonhosted.org/packages/3e/2d/9fb725a4e7cd22cd1858b29a960b7fc6bf230ef7be351b70b18b0555b21c/django_compressor-4.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/2d/9fb725a4e7cd22cd1858b29a960b7fc6bf230ef7be351b70b18b0555b21c/django_compressor-4.3.tar.gz
...
%prep
%setup -q -n django_compressor-4.3
cd %{_builddir}/django_compressor-4.3
pushd ..
cp -a django_compressor-4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673281221
