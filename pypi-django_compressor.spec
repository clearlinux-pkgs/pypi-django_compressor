...
Version  : 4.3.1
Release  : 73
URL      : https://files.pythonhosted.org/packages/2d/40/1c8b0073bd5e4b4395137191ab5e77f905b309c3bc75f1d6f97d0b6d9bd2/django_compressor-4.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/2d/40/1c8b0073bd5e4b4395137191ab5e77f905b309c3bc75f1d6f97d0b6d9bd2/django_compressor-4.3.1.tar.gz
...
%prep
%setup -q -n django_compressor-4.3.1
cd %{_builddir}/django_compressor-4.3.1
pushd ..
cp -a django_compressor-4.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674494417
